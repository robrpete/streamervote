  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-b from-black to-[#18181B]">
        <div className="hidden h-12 w-full items-center justify-evenly bg-[#18181B] text-lg font-semibold text-white md:flex">
          <div>SV</div>
        ...
        <div className="flex h-12 w-full items-center justify-evenly bg-[#18181B] text-lg font-semibold text-white md:hidden">
          <div>SV</div>
          <div className=" flex flex-col items-center justify-center">
            <div className="mb-1 h-1 w-1 rounded-full bg-white"></div>
            <div className="mb-1 h-1 w-1 rounded-full bg-white"></div>
